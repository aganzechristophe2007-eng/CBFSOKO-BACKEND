-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'SELLER', 'SHOP_OWNER', 'MODERATOR', 'ADMIN', 'SUPER_ADMIN');

-- CreateEnum
CREATE TYPE "ProductState" AS ENUM ('NEW', 'LIKE_NEW', 'GOOD', 'ACCEPTABLE');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('PENDING', 'ACTIVE', 'REJECTED', 'SOLD', 'ARCHIVED');
...
CREATE TABLE "Delivery" (
    ...
    "latitude" DOUBLE PRECISION,
    "longitude" DOUBLE PRECISION,
    "fraisCDF" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "fraisUSD" DOUBLE PRECISION NOT NULL DEFAULT 0,
